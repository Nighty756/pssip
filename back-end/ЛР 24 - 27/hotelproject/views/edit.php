...
<section class="aparts_block">
    <div class="aparts_container container">
        <h1 class="aparts_title title_block">Редактирование категории</h1>
        ...
        <div class="aparts_body">
            ...
            <form method="post" action="edit.php" enctype="multipart/form-data">
                    ...
                    <div class="aparts_input-group">
                        <label class="input-label" for="title">Название</label>
                    ...
                    <div class="aparts_input-group">
                        ...
                        <input type="text" value="<?= $square ?>" id="name" name="square">
                        <?= $err['square'] ?>
                    </div>
                    ...
                    <label class="input-file">
	   	                ...
	   	                <input type="file" value="<?= $imgarr; ?>" name="img[]" multiple>        
 	   	                <span class="input-file-btn">Выбрать изображение</span>
 	                </label>
                    </div>

                    <button type="submit" name="apart-edit" class="aparts_btn">Обновить категорию</button>
            </form>
